...
import { CurveFactory, PriorityCurve, AsyncPriorityCurve } from './curves';
import { DependencyChecker } from './curves/blocked';
...
export class TaskService implements DependencyChecker {
  ...
  private isAsyncCurve(
    curve: PriorityCurve | AsyncPriorityCurve
  ): curve is AsyncPriorityCurve {
